...
extension ViewController {
    ...
    func applyProcessingOnVideo(videoURL:URL, _ processingFunction: @escaping ((CIImage) -> CIImage?), _ completion: ((_ err: NSError?, _ processedVideoURL: URL?) -> Void)?) {
        ...
        print("prefered rate",asset.preferredRate)
        ...
        let readerVideoOutput: AVAssetReaderTrackOutput = AVAssetReaderTrackOutput(
            ...
            outputSettings: [
                ...
                kCVPixelBufferPixelFormatTypeKey as String: Int(kCVPixelFormatType_24RGB),
            ]
        )
        ...
        case 90:
            ...
            print("estimatedDataRate: \(asset.tracks(withMediaType: AVMediaType.video)[0].estimatedDataRate)")
    ...
    func savedVideo(url:URL,complection: @escaping((Bool) -> Void )) {
        do {
